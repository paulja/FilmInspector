...
//  FilmInspector
//
//  Created by Paul Jackson on 03/01/2021.
//

import Foundation

extension UserDefaults {
    /// Maximum number of items to keep in the recent search list.
    ...
    var recents: [String] {
        guard
            let recents = UserDefaults.shared.object(forKey: AppKeys.recents.rawValue) as? [String]
        else {
            return []
        }
        return recents
